...
char RubiksCube::getColorLetter(COLOR color)
{
    ...
    throw invalid_argument("Invalid RubiksCube color");
}
...
string RubiksCube::getMove(MOVE ind)
{
    ...
    throw invalid_argument("Invalid RubiksCube move");
}
...
uint8_t RubiksCube::getCornerOrientation(uint8_t ind) const{
    ...
    if(corner[1] == temp[0]) return 1;
    else if(corner[2] == temp[0]) return 2;
    else return 0;
}
